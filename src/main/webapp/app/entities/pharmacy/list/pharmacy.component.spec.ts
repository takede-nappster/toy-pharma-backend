...
describe('Pharmacy Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'pharmacy', component: PharmacyComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.pharmacies?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
