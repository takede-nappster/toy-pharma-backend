...
export class PharmacyComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.pharmacyService
      ...
      .subscribe({
        next: (res: HttpResponse<IPharmacy[]>) => {
  ...
  trackId(_index: number, item: IPharmacy): number {
    return item.id!;
  }

  delete(pharmacy: IPharmacy): void {
  ...
  protected onSuccess(data: IPharmacy[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
