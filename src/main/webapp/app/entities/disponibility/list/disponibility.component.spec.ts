...
describe('Disponibility Management Component', () => {
  let comp: DisponibilityComponent;
  let fixture: ComponentFixture<DisponibilityComponent>;
  let service: DisponibilityService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'disponibility', component: DisponibilityComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(DisponibilityComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.disponibilities?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
